...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(arg) => "外部 IP:\t\t ${arg}";

  static String m7(arg) => "内部 IP:\t\t ${arg}";

  static String m8(number) => " (${number} 项)";

  static String m9(n) => "最近 ${n} 警告";

  static String m10(error) => "加载指标错误: ${error}";

  static String m11(arg) => "架构\t\t: ${arg}";

  static String m12(os, arg) => "内核:\t\t ${os}/${arg}";

  static String m13(arg) => "系统镜像:\t\t ${arg}";

  static String m14(arg) => "角色:\t\t ${arg}";

  static String m15(arg) => "版本:\t\t ${arg}";

  static String m16(
          name, namespace, ready, status, restarts, containers, cpu, memory) =>
      "${name}\n\n名字空间: ${namespace}\n就绪: ${ready}\n状况: ${status}\n重启: ${restarts}\n容器: ${containers}\nCPU: ${cpu}\n内存: ${memory}";

  static String m17(number) => "总计: ${number}";

  static String m18(type, name) => "将要删除 ${type} ${name}";
