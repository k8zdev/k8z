...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(arg) => "外部 IP:\t\t ${arg}";

  static String m9(name, ns, className, hosts, address, ports) =>
      "${name}\n名字空间: ${ns}\n类: ${className}\n主机: ${hosts}\n地址: ${address}\n端口: ${ports}";

  static String m10(arg) => "内部 IP:\t\t ${arg}";

  static String m11(number) => " (${number} 项)";

  static String m12(n) => "最近 ${n} 警告";

  static String m13(error) => "加载指标错误: ${error}";

  static String m14(arg) => "架构\t\t: ${arg}";

  static String m15(os, arg) => "内核:\t\t ${os}/${arg}";

  static String m16(arg) => "系统镜像:\t\t ${arg}";

  static String m17(arg) => "角色:\t\t ${arg}";

  static String m18(arg) => "版本:\t\t ${arg}";
  ...
  static String m22(number) => "总计: ${number}";

  static String m23(type, name) => "将要删除 ${type} ${name}";
