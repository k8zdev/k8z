...
Future<void> initStore() async {
  database = await openDatabase(
    ...
    onCreate: (db, version) async {
      ...
      batch.execute(sqlCreateOnboardingGuideStateTable);
...
Future<void> up2to3(Database db) async {
  talker.log("Upgrading database from version 2 to 3");

  // Create onboarding_guide_state table
  await db.execute(sqlCreateOnboardingGuideStateTable);

  talker.log("Database upgrade from version 2 to 3 completed");
}
