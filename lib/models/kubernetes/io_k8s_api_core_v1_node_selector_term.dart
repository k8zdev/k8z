...
class IoK8sApiCoreV1NodeSelectorTerm {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1NodeSelectorTerm &&
    _deepEquality.equals(other.matchExpressions, matchExpressions) &&
    _deepEquality.equals(other.matchFields, matchFields);
  ...
  static IoK8sApiCoreV1NodeSelectorTerm? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1NodeSelectorTerm(
        matchExpressions: IoK8sApiCoreV1NodeSelectorRequirement.listFromJson(json[r'matchExpressions']),
        matchFields: IoK8sApiCoreV1NodeSelectorRequirement.listFromJson(json[r'matchFields']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<IoK8sApiCoreV1NodeSelectorTerm>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1NodeSelectorTerm.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
