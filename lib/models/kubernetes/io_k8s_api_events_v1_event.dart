...
class IoK8sApiEventsV1Event {
  ...
  static IoK8sApiEventsV1Event? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiEventsV1Event(
        ...
        deprecatedFirstTimestamp: mapDateTime(json, r'deprecatedFirstTimestamp', r''),
        deprecatedLastTimestamp: mapDateTime(json, r'deprecatedLastTimestamp', r''),
  ...
  static Map<String, List<IoK8sApiEventsV1Event>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiEventsV1Event.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
