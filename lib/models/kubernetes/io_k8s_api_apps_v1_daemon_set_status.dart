...
class IoK8sApiAppsV1DaemonSetStatus {
  ...
  static IoK8sApiAppsV1DaemonSetStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiAppsV1DaemonSetStatus(
        ...
        conditions: IoK8sApiAppsV1DaemonSetCondition.listFromJson(json[r'conditions']),
  ...
  static Map<String, List<IoK8sApiAppsV1DaemonSetStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiAppsV1DaemonSetStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
