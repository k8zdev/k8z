...
class IoK8sApiCoreV1LimitRangeItem {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1LimitRangeItem &&
    _deepEquality.equals(other.default_, default_) &&
    _deepEquality.equals(other.defaultRequest, defaultRequest) &&
    _deepEquality.equals(other.max, max) &&
    _deepEquality.equals(other.maxLimitRequestRatio, maxLimitRequestRatio) &&
    _deepEquality.equals(other.min, min) &&
    other.type == type;
  ...
  static Map<String, List<IoK8sApiCoreV1LimitRangeItem>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1LimitRangeItem.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
