...
class IoK8sApiStorageV1CSINodeDriver {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1CSINodeDriver &&
    ...
    other.name == name &&
    other.nodeID == nodeID &&
    _deepEquality.equals(other.topologyKeys, topologyKeys);
  ...
  static IoK8sApiStorageV1CSINodeDriver? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiStorageV1CSINodeDriver(
        ...
        topologyKeys: json[r'topologyKeys'] is Iterable
            ? (json[r'topologyKeys'] as Iterable).cast<String>().toList(growable: false)
            : const [],
      );
    }
    return null;
  ...
  static Map<String, List<IoK8sApiStorageV1CSINodeDriver>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiStorageV1CSINodeDriver.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
