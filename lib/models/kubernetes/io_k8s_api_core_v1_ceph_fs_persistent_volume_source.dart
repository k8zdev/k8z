...
class IoK8sApiCoreV1CephFSPersistentVolumeSource {
  ...
  static IoK8sApiCoreV1CephFSPersistentVolumeSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1CephFSPersistentVolumeSource(
        monitors: json[r'monitors'] is Iterable
            ? (json[r'monitors'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<IoK8sApiCoreV1CephFSPersistentVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1CephFSPersistentVolumeSource.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
