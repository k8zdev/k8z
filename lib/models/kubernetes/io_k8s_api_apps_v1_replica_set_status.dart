...
class IoK8sApiAppsV1ReplicaSetStatus {
  ...
  static IoK8sApiAppsV1ReplicaSetStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiAppsV1ReplicaSetStatus(
        ...
        conditions: IoK8sApiAppsV1ReplicaSetCondition.listFromJson(json[r'conditions']),
  ...
  static Map<String, List<IoK8sApiAppsV1ReplicaSetStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiAppsV1ReplicaSetStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
