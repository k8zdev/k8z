...
class IoK8sApiAdmissionregistrationV1ValidatingWebhook {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAdmissionregistrationV1ValidatingWebhook &&
    _deepEquality.equals(other.admissionReviewVersions, admissionReviewVersions) &&
  ...
  static IoK8sApiAdmissionregistrationV1ValidatingWebhook? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiAdmissionregistrationV1ValidatingWebhook(
        admissionReviewVersions: json[r'admissionReviewVersions'] is Iterable
            ? (json[r'admissionReviewVersions'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        rules: IoK8sApiAdmissionregistrationV1RuleWithOperations.listFromJson(json[r'rules']),
  ...
  static Map<String, List<IoK8sApiAdmissionregistrationV1ValidatingWebhook>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiAdmissionregistrationV1ValidatingWebhook.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
