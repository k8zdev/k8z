...
class IoK8sApiCoreV1PersistentVolumeClaimSpec {
  ...
  static IoK8sApiCoreV1PersistentVolumeClaimSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1PersistentVolumeClaimSpec(
        ...
        dataSourceRef: IoK8sApiCoreV1TypedLocalObjectReference.fromJson(json[r'dataSourceRef']),
  ...
  static Map<String, List<IoK8sApiCoreV1PersistentVolumeClaimSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1PersistentVolumeClaimSpec.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
