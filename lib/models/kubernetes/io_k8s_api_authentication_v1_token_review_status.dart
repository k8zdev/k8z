...
class IoK8sApiAuthenticationV1TokenReviewStatus {
  ...
  static IoK8sApiAuthenticationV1TokenReviewStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiAuthenticationV1TokenReviewStatus(
        audiences: json[r'audiences'] is Iterable
            ? (json[r'audiences'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<IoK8sApiAuthenticationV1TokenReviewStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiAuthenticationV1TokenReviewStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
