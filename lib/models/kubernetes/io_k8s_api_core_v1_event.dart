...
class IoK8sApiCoreV1Event {
  ...
  static IoK8sApiCoreV1Event? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1Event(
        ...
        firstTimestamp: mapDateTime(json, r'firstTimestamp', r''),
        involvedObject: IoK8sApiCoreV1ObjectReference.fromJson(json[r'involvedObject'])!,
        kind: mapValueOfType<String>(json, r'kind'),
        lastTimestamp: mapDateTime(json, r'lastTimestamp', r''),
  ...
  static Map<String, List<IoK8sApiCoreV1Event>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1Event.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
