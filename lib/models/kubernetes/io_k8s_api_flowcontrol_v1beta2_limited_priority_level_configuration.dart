...
class IoK8sApiFlowcontrolV1beta2LimitedPriorityLevelConfiguration {
  ...
  @override
  String toString() => 'IoK8sApiFlowcontrolV1beta2LimitedPriorityLevelConfiguration[assuredConcurrencyShares=$assuredConcurrencyShares, limitResponse=$limitResponse]';
  ...
  static Map<String, List<IoK8sApiFlowcontrolV1beta2LimitedPriorityLevelConfiguration>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiFlowcontrolV1beta2LimitedPriorityLevelConfiguration.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
