...
class IoK8sApiAppsV1DeploymentStatus {
  ...
  static IoK8sApiAppsV1DeploymentStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiAppsV1DeploymentStatus(
        ...
        conditions: IoK8sApiAppsV1DeploymentCondition.listFromJson(json[r'conditions']),
  ...
  static Map<String, List<IoK8sApiAppsV1DeploymentStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiAppsV1DeploymentStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
