...
class IoK8sApiCoreV1PodStatus {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PodStatus &&
    ...
    _deepEquality.equals(other.containerStatuses, containerStatuses) &&
    _deepEquality.equals(other.ephemeralContainerStatuses, ephemeralContainerStatuses) &&
    other.hostIP == hostIP &&
    _deepEquality.equals(other.initContainerStatuses, initContainerStatuses) &&
    other.message == message &&
    other.nominatedNodeName == nominatedNodeName &&
    other.phase == phase &&
    other.podIP == podIP &&
    _deepEquality.equals(other.podIPs, podIPs) &&
  ...
  static IoK8sApiCoreV1PodStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1PodStatus(
        conditions: IoK8sApiCoreV1PodCondition.listFromJson(json[r'conditions']),
        containerStatuses: IoK8sApiCoreV1ContainerStatus.listFromJson(json[r'containerStatuses']),
        ephemeralContainerStatuses: IoK8sApiCoreV1ContainerStatus.listFromJson(json[r'ephemeralContainerStatuses']),
        hostIP: mapValueOfType<String>(json, r'hostIP'),
        initContainerStatuses: IoK8sApiCoreV1ContainerStatus.listFromJson(json[r'initContainerStatuses']),
        ...
        podIPs: IoK8sApiCoreV1PodIP.listFromJson(json[r'podIPs']),
  ...
  static Map<String, List<IoK8sApiCoreV1PodStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1PodStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
