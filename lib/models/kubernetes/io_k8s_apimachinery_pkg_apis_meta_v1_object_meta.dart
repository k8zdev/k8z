...
class IoK8sApimachineryPkgApisMetaV1ObjectMeta {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApimachineryPkgApisMetaV1ObjectMeta &&
    ...
    _deepEquality.equals(other.finalizers, finalizers) &&
    other.generateName == generateName &&
    other.generation == generation &&
    _deepEquality.equals(other.labels, labels) &&
    _deepEquality.equals(other.managedFields, managedFields) &&
    other.name == name &&
    other.namespace == namespace &&
    _deepEquality.equals(other.ownerReferences, ownerReferences) &&
  ...
  static IoK8sApimachineryPkgApisMetaV1ObjectMeta? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApimachineryPkgApisMetaV1ObjectMeta(
        ...
        creationTimestamp: mapDateTime(json, r'creationTimestamp', r''),
        deletionGracePeriodSeconds: mapValueOfType<int>(json, r'deletionGracePeriodSeconds'),
        deletionTimestamp: mapDateTime(json, r'deletionTimestamp', r''),
        finalizers: json[r'finalizers'] is Iterable
            ? (json[r'finalizers'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        managedFields: IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry.listFromJson(json[r'managedFields']),
        name: mapValueOfType<String>(json, r'name'),
        namespace: mapValueOfType<String>(json, r'namespace'),
        ownerReferences: IoK8sApimachineryPkgApisMetaV1OwnerReference.listFromJson(json[r'ownerReferences']),
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1ObjectMeta>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApimachineryPkgApisMetaV1ObjectMeta.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
