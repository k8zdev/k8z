...
class IoK8sApiCoreV1NodeStatus {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1NodeStatus &&
    ...
    _deepEquality.equals(other.allocatable, allocatable) &&
    _deepEquality.equals(other.capacity, capacity) &&
    ...
    other.phase == phase &&
    _deepEquality.equals(other.volumesAttached, volumesAttached) &&
    _deepEquality.equals(other.volumesInUse, volumesInUse);
  ...
  static IoK8sApiCoreV1NodeStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1NodeStatus(
        ...
        conditions: IoK8sApiCoreV1NodeCondition.listFromJson(json[r'conditions']),
        ...
        volumesAttached: IoK8sApiCoreV1AttachedVolume.listFromJson(json[r'volumesAttached']),
        volumesInUse: json[r'volumesInUse'] is Iterable
            ? (json[r'volumesInUse'] as Iterable).cast<String>().toList(growable: false)
            : const [],
      );
    }
    return null;
  ...
  static Map<String, List<IoK8sApiCoreV1NodeStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1NodeStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
