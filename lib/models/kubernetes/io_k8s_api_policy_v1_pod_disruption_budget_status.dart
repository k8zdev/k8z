...
class IoK8sApiPolicyV1PodDisruptionBudgetStatus {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiPolicyV1PodDisruptionBudgetStatus &&
    ...
    _deepEquality.equals(other.disruptedPods, disruptedPods) &&
  ...
  static IoK8sApiPolicyV1PodDisruptionBudgetStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiPolicyV1PodDisruptionBudgetStatus(
        ...
        disruptedPods: mapValueOfType<Map<String, DateTime>>(json, r'disruptedPods') ?? const {},
  ...
  static Map<String, List<IoK8sApiPolicyV1PodDisruptionBudgetStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiPolicyV1PodDisruptionBudgetStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
