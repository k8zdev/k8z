...
class IoK8sApiBatchV1CronJobStatus {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiBatchV1CronJobStatus &&
    _deepEquality.equals(other.active, active) &&
  ...
  static IoK8sApiBatchV1CronJobStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiBatchV1CronJobStatus(
        ...
        lastScheduleTime: mapDateTime(json, r'lastScheduleTime', r''),
        lastSuccessfulTime: mapDateTime(json, r'lastSuccessfulTime', r''),
      );
    }
    return null;
  }
  ...
  static Map<String, List<IoK8sApiBatchV1CronJobStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiBatchV1CronJobStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
