...
class IoK8sApiCoreV1PersistentVolumeSpec {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PersistentVolumeSpec &&
    _deepEquality.equals(other.accessModes, accessModes) &&
    ...
    other.iscsi == iscsi &&
    other.local == local &&
    _deepEquality.equals(other.mountOptions, mountOptions) &&
    other.nfs == nfs &&
  ...
  static IoK8sApiCoreV1PersistentVolumeSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1PersistentVolumeSpec(
        accessModes: json[r'accessModes'] is Iterable
            ? (json[r'accessModes'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        mountOptions: json[r'mountOptions'] is Iterable
            ? (json[r'mountOptions'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<IoK8sApiCoreV1PersistentVolumeSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1PersistentVolumeSpec.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
