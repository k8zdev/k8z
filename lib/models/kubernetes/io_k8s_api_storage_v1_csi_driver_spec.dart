...
class IoK8sApiStorageV1CSIDriverSpec {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1CSIDriverSpec &&
    ...
    _deepEquality.equals(other.tokenRequests, tokenRequests) &&
    _deepEquality.equals(other.volumeLifecycleModes, volumeLifecycleModes);
  ...
  static IoK8sApiStorageV1CSIDriverSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiStorageV1CSIDriverSpec(
        ...
        tokenRequests: IoK8sApiStorageV1TokenRequest.listFromJson(json[r'tokenRequests']),
        volumeLifecycleModes: json[r'volumeLifecycleModes'] is Iterable
            ? (json[r'volumeLifecycleModes'] as Iterable).cast<String>().toList(growable: false)
            : const [],
      );
    }
    return null;
  ...
  static Map<String, List<IoK8sApiStorageV1CSIDriverSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiStorageV1CSIDriverSpec.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
