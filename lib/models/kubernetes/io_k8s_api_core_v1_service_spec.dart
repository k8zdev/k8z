...
class IoK8sApiCoreV1ServiceSpec {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ServiceSpec &&
    ...
    _deepEquality.equals(other.clusterIPs, clusterIPs) &&
    _deepEquality.equals(other.externalIPs, externalIPs) &&
  ...
  static IoK8sApiCoreV1ServiceSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1ServiceSpec(
        ...
        clusterIPs: json[r'clusterIPs'] is Iterable
            ? (json[r'clusterIPs'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        externalIPs: json[r'externalIPs'] is Iterable
            ? (json[r'externalIPs'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        ipFamilies: json[r'ipFamilies'] is Iterable
            ? (json[r'ipFamilies'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ...
        loadBalancerSourceRanges: json[r'loadBalancerSourceRanges'] is Iterable
            ? (json[r'loadBalancerSourceRanges'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        ports: IoK8sApiCoreV1ServicePort.listFromJson(json[r'ports']),
  ...
  static Map<String, List<IoK8sApiCoreV1ServiceSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1ServiceSpec.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
