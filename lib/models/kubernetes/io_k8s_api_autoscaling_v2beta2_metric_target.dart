...
class IoK8sApiAutoscalingV2beta2MetricTarget {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAutoscalingV2beta2MetricTarget &&
  ...
  @override
  String toString() => 'IoK8sApiAutoscalingV2beta2MetricTarget[averageUtilization=$averageUtilization, averageValue=$averageValue, type=$type, value=$value]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAutoscalingV2beta2MetricTarget[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAutoscalingV2beta2MetricTarget[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAutoscalingV2beta2MetricTarget> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAutoscalingV2beta2MetricTarget> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiAutoscalingV2beta2MetricTarget>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAutoscalingV2beta2MetricTarget.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiAutoscalingV2beta2MetricTarget>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAutoscalingV2beta2MetricTarget>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiAutoscalingV2beta2MetricTarget.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
