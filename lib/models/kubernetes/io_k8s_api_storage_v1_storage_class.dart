...
class IoK8sApiStorageV1StorageClass {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1StorageClass &&
    ...
    _deepEquality.equals(other.allowedTopologies, allowedTopologies) &&
  ...
  static IoK8sApiStorageV1StorageClass? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiStorageV1StorageClass(
        ...
        allowedTopologies: IoK8sApiCoreV1TopologySelectorTerm.listFromJson(json[r'allowedTopologies']),
  ...
  static Map<String, List<IoK8sApiStorageV1StorageClass>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiStorageV1StorageClass.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
