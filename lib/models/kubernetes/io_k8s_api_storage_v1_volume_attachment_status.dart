...
class IoK8sApiStorageV1VolumeAttachmentStatus {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1VolumeAttachmentStatus &&
    ...
    _deepEquality.equals(other.attachmentMetadata, attachmentMetadata) &&
  ...
  static Map<String, List<IoK8sApiStorageV1VolumeAttachmentStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiStorageV1VolumeAttachmentStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
