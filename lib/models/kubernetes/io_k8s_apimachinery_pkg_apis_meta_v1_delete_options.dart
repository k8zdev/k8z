...
class IoK8sApimachineryPkgApisMetaV1DeleteOptions {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApimachineryPkgApisMetaV1DeleteOptions &&
    ...
    _deepEquality.equals(other.dryRun, dryRun) &&
  ...
  static IoK8sApimachineryPkgApisMetaV1DeleteOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApimachineryPkgApisMetaV1DeleteOptions(
        ...
        dryRun: json[r'dryRun'] is Iterable
            ? (json[r'dryRun'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1DeleteOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApimachineryPkgApisMetaV1DeleteOptions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
