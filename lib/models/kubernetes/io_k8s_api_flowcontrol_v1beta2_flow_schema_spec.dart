...
class IoK8sApiFlowcontrolV1beta2FlowSchemaSpec {
  ...
  static IoK8sApiFlowcontrolV1beta2FlowSchemaSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiFlowcontrolV1beta2FlowSchemaSpec(
        ...
        rules: IoK8sApiFlowcontrolV1beta2PolicyRulesWithSubjects.listFromJson(json[r'rules']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<IoK8sApiFlowcontrolV1beta2FlowSchemaSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiFlowcontrolV1beta2FlowSchemaSpec.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
