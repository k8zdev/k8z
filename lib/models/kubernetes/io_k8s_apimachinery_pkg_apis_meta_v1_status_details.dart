...
class IoK8sApimachineryPkgApisMetaV1StatusDetails {
  ...
  static IoK8sApimachineryPkgApisMetaV1StatusDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApimachineryPkgApisMetaV1StatusDetails(
        causes: IoK8sApimachineryPkgApisMetaV1StatusCause.listFromJson(json[r'causes']),
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1StatusDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApimachineryPkgApisMetaV1StatusDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
