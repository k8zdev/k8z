...
class IoK8sApiCoreV1ScopeSelector {
  ...
  static IoK8sApiCoreV1ScopeSelector? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1ScopeSelector(
        matchExpressions: IoK8sApiCoreV1ScopedResourceSelectorRequirement.listFromJson(json[r'matchExpressions']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<IoK8sApiCoreV1ScopeSelector>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1ScopeSelector.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
