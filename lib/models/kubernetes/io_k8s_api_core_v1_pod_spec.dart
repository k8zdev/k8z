...
class IoK8sApiCoreV1PodSpec {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PodSpec &&
    ...
    _deepEquality.equals(other.ephemeralContainers, ephemeralContainers) &&
    _deepEquality.equals(other.hostAliases, hostAliases) &&
    ...
    _deepEquality.equals(other.initContainers, initContainers) &&
    other.nodeName == nodeName &&
    _deepEquality.equals(other.nodeSelector, nodeSelector) &&
    other.os == os &&
    _deepEquality.equals(other.overhead, overhead) &&
    other.preemptionPolicy == preemptionPolicy &&
    other.priority == priority &&
    other.priorityClassName == priorityClassName &&
    _deepEquality.equals(other.readinessGates, readinessGates) &&
    ...
    _deepEquality.equals(other.tolerations, tolerations) &&
    _deepEquality.equals(other.topologySpreadConstraints, topologySpreadConstraints) &&
  ...
  static IoK8sApiCoreV1PodSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1PodSpec(
        ...
        ephemeralContainers: IoK8sApiCoreV1EphemeralContainer.listFromJson(json[r'ephemeralContainers']),
        hostAliases: IoK8sApiCoreV1HostAlias.listFromJson(json[r'hostAliases']),
        ...
        initContainers: IoK8sApiCoreV1Container.listFromJson(json[r'initContainers']),
        ...
        readinessGates: IoK8sApiCoreV1PodReadinessGate.listFromJson(json[r'readinessGates']),
        ...
        tolerations: IoK8sApiCoreV1Toleration.listFromJson(json[r'tolerations']),
        topologySpreadConstraints: IoK8sApiCoreV1TopologySpreadConstraint.listFromJson(json[r'topologySpreadConstraints']),
        volumes: IoK8sApiCoreV1Volume.listFromJson(json[r'volumes']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<IoK8sApiCoreV1PodSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1PodSpec.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
