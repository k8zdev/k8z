...
class IoK8sApiCertificatesV1CertificateSigningRequestSpec {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCertificatesV1CertificateSigningRequestSpec &&
    ...
    other.uid == uid &&
    _deepEquality.equals(other.usages, usages) &&
  ...
  static IoK8sApiCertificatesV1CertificateSigningRequestSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCertificatesV1CertificateSigningRequestSpec(
        ...
        usages: json[r'usages'] is Iterable
            ? (json[r'usages'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<IoK8sApiCertificatesV1CertificateSigningRequestSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCertificatesV1CertificateSigningRequestSpec.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
