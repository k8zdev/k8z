...
class IoK8sApiCoreV1NodeSpec {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1NodeSpec &&
    ...
    _deepEquality.equals(other.podCIDRs, podCIDRs) &&
  ...
  static IoK8sApiCoreV1NodeSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1NodeSpec(
        ...
        podCIDRs: json[r'podCIDRs'] is Iterable
            ? (json[r'podCIDRs'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        providerID: mapValueOfType<String>(json, r'providerID'),
        taints: IoK8sApiCoreV1Taint.listFromJson(json[r'taints']),
  ...
  static Map<String, List<IoK8sApiCoreV1NodeSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1NodeSpec.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
