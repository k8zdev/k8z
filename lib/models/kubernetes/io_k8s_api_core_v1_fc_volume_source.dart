...
class IoK8sApiCoreV1FCVolumeSource {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1FCVolumeSource &&
    ...
    _deepEquality.equals(other.targetWWNs, targetWWNs) &&
    _deepEquality.equals(other.wwids, wwids);
  ...
  static IoK8sApiCoreV1FCVolumeSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1FCVolumeSource(
        ...
        targetWWNs: json[r'targetWWNs'] is Iterable
            ? (json[r'targetWWNs'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        wwids: json[r'wwids'] is Iterable
            ? (json[r'wwids'] as Iterable).cast<String>().toList(growable: false)
            : const [],
      );
    }
    return null;
  ...
  static Map<String, List<IoK8sApiCoreV1FCVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1FCVolumeSource.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
