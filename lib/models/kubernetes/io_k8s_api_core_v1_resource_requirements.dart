...
class IoK8sApiCoreV1ResourceRequirements {
  ...
  @override
  String toString() => 'IoK8sApiCoreV1ResourceRequirements[limits=$limits, requests=$requests]';
  ...
  static Map<String, List<IoK8sApiCoreV1ResourceRequirements>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1ResourceRequirements.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
