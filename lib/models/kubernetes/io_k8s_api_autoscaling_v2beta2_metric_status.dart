...
class IoK8sApiAutoscalingV2beta2MetricStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAutoscalingV2beta2MetricStatus &&
  ...
  @override
  String toString() => 'IoK8sApiAutoscalingV2beta2MetricStatus[containerResource=$containerResource, external_=$external_, object=$object, pods=$pods, resource=$resource, type=$type]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAutoscalingV2beta2MetricStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAutoscalingV2beta2MetricStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiAutoscalingV2beta2MetricStatus(
        containerResource: IoK8sApiAutoscalingV2beta2ContainerResourceMetricStatus.fromJson(json[r'containerResource']),
        external_: IoK8sApiAutoscalingV2beta2ExternalMetricStatus.fromJson(json[r'external']),
        object: IoK8sApiAutoscalingV2beta2ObjectMetricStatus.fromJson(json[r'object']),
        pods: IoK8sApiAutoscalingV2beta2PodsMetricStatus.fromJson(json[r'pods']),
        resource: IoK8sApiAutoscalingV2beta2ResourceMetricStatus.fromJson(json[r'resource']),
  ...
  static List<IoK8sApiAutoscalingV2beta2MetricStatus> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAutoscalingV2beta2MetricStatus> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiAutoscalingV2beta2MetricStatus>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAutoscalingV2beta2MetricStatus.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiAutoscalingV2beta2MetricStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAutoscalingV2beta2MetricStatus>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiAutoscalingV2beta2MetricStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
