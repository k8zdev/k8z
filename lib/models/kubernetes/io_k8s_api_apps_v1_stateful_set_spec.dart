...
class IoK8sApiAppsV1StatefulSetSpec {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1StatefulSetSpec &&
    ...
    _deepEquality.equals(other.volumeClaimTemplates, volumeClaimTemplates);
  ...
  static IoK8sApiAppsV1StatefulSetSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiAppsV1StatefulSetSpec(
        ...
        volumeClaimTemplates: IoK8sApiCoreV1PersistentVolumeClaim.listFromJson(json[r'volumeClaimTemplates']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<IoK8sApiAppsV1StatefulSetSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiAppsV1StatefulSetSpec.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
