...
class IoK8sApiCoreV1PodDNSConfig {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PodDNSConfig &&
    ...
    _deepEquality.equals(other.searches, searches);
    ...
    if (value is Map) {
      ...
      return IoK8sApiCoreV1PodDNSConfig(
        nameservers: json[r'nameservers'] is Iterable
            ...
            : const [],
        options: IoK8sApiCoreV1PodDNSConfigOption.listFromJson(json[r'options']),
        searches: json[r'searches'] is Iterable
            ? (json[r'searches'] as Iterable).cast<String>().toList(growable: false)
            : const [],
      );
    }
    return null;
  ...
  static Map<String, List<IoK8sApiCoreV1PodDNSConfig>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1PodDNSConfig.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
