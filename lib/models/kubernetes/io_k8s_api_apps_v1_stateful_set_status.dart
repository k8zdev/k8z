...
class IoK8sApiAppsV1StatefulSetStatus {
  ...
  static IoK8sApiAppsV1StatefulSetStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiAppsV1StatefulSetStatus(
        ...
        conditions: IoK8sApiAppsV1StatefulSetCondition.listFromJson(json[r'conditions']),
  ...
  static Map<String, List<IoK8sApiAppsV1StatefulSetStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiAppsV1StatefulSetStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
