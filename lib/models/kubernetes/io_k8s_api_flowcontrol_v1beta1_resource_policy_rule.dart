...
class IoK8sApiFlowcontrolV1beta1ResourcePolicyRule {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiFlowcontrolV1beta1ResourcePolicyRule &&
  ...
  @override
  String toString() => 'IoK8sApiFlowcontrolV1beta1ResourcePolicyRule[apiGroups=$apiGroups, clusterScope=$clusterScope, namespaces=$namespaces, resources=$resources, verbs=$verbs]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiFlowcontrolV1beta1ResourcePolicyRule[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiFlowcontrolV1beta1ResourcePolicyRule[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiFlowcontrolV1beta1ResourcePolicyRule> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IoK8sApiFlowcontrolV1beta1ResourcePolicyRule>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoK8sApiFlowcontrolV1beta1ResourcePolicyRule.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoK8sApiFlowcontrolV1beta1ResourcePolicyRule> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiFlowcontrolV1beta1ResourcePolicyRule>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiFlowcontrolV1beta1ResourcePolicyRule.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiFlowcontrolV1beta1ResourcePolicyRule>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiFlowcontrolV1beta1ResourcePolicyRule>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiFlowcontrolV1beta1ResourcePolicyRule.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
