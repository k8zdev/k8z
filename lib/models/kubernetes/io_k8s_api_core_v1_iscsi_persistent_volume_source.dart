...
class IoK8sApiCoreV1ISCSIPersistentVolumeSource {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ISCSIPersistentVolumeSource &&
    ...
    other.lun == lun &&
    _deepEquality.equals(other.portals, portals) &&
  ...
  static IoK8sApiCoreV1ISCSIPersistentVolumeSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1ISCSIPersistentVolumeSource(
        ...
        portals: json[r'portals'] is Iterable
            ? (json[r'portals'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<IoK8sApiCoreV1ISCSIPersistentVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1ISCSIPersistentVolumeSource.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
