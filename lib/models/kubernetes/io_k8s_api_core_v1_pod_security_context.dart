...
class IoK8sApiCoreV1PodSecurityContext {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PodSecurityContext &&
    ...
    _deepEquality.equals(other.supplementalGroups, supplementalGroups) &&
    ...
    if (value is Map) {
      ...
      return IoK8sApiCoreV1PodSecurityContext(
        ...
        supplementalGroups: json[r'supplementalGroups'] is Iterable
            ? (json[r'supplementalGroups'] as Iterable).cast<int>().toList(growable: false)
            : const [],
        sysctls: IoK8sApiCoreV1Sysctl.listFromJson(json[r'sysctls']),
  ...
  static Map<String, List<IoK8sApiCoreV1PodSecurityContext>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1PodSecurityContext.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
