...
class IoK8sApiCoreV1EndpointSubset {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1EndpointSubset &&
    ...
    _deepEquality.equals(other.notReadyAddresses, notReadyAddresses) &&
  ...
  static IoK8sApiCoreV1EndpointSubset? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1EndpointSubset(
        addresses: IoK8sApiCoreV1EndpointAddress.listFromJson(json[r'addresses']),
        notReadyAddresses: IoK8sApiCoreV1EndpointAddress.listFromJson(json[r'notReadyAddresses']),
        ports: IoK8sApiCoreV1EndpointPort.listFromJson(json[r'ports']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<IoK8sApiCoreV1EndpointSubset>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1EndpointSubset.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
