...
class IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus {
  ...
  static IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus(
        conditions: IoK8sApiAutoscalingV2HorizontalPodAutoscalerCondition.listFromJson(json[r'conditions']),
        currentMetrics: IoK8sApiAutoscalingV2MetricStatus.listFromJson(json[r'currentMetrics']),
  ...
  static Map<String, List<IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
