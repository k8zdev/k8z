...
class IoK8sApiAdmissionregistrationV1RuleWithOperations {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAdmissionregistrationV1RuleWithOperations &&
    ...
    _deepEquality.equals(other.apiVersions, apiVersions) &&
    ...
    if (value is Map) {
      ...
      return IoK8sApiAdmissionregistrationV1RuleWithOperations(
        ...
        apiVersions: json[r'apiVersions'] is Iterable
            ? (json[r'apiVersions'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<IoK8sApiAdmissionregistrationV1RuleWithOperations>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiAdmissionregistrationV1RuleWithOperations.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
