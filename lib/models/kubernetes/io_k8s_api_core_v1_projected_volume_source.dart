...
class IoK8sApiCoreV1ProjectedVolumeSource {
  ...
  static IoK8sApiCoreV1ProjectedVolumeSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1ProjectedVolumeSource(
        ...
        sources: IoK8sApiCoreV1VolumeProjection.listFromJson(json[r'sources']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<IoK8sApiCoreV1ProjectedVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1ProjectedVolumeSource.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
