...
class IoK8sApiCoreV1EphemeralContainer {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1EphemeralContainer &&
    ...
    _deepEquality.equals(other.envFrom, envFrom) &&
    other.image == image &&
    ...
    other.tty == tty &&
    _deepEquality.equals(other.volumeDevices, volumeDevices) &&
    _deepEquality.equals(other.volumeMounts, volumeMounts) &&
    ...
    if (value is Map) {
      ...
      return IoK8sApiCoreV1EphemeralContainer(
        ...
        command: json[r'command'] is Iterable
            ...
            : const [],
        env: IoK8sApiCoreV1EnvVar.listFromJson(json[r'env']),
        ...
        volumeDevices: IoK8sApiCoreV1VolumeDevice.listFromJson(json[r'volumeDevices']),
        volumeMounts: IoK8sApiCoreV1VolumeMount.listFromJson(json[r'volumeMounts']),
  ...
  static Map<String, List<IoK8sApiCoreV1EphemeralContainer>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1EphemeralContainer.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
