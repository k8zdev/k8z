...
class IoK8sApiCoreV1TopologySpreadConstraint {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1TopologySpreadConstraint &&
    ...
    _deepEquality.equals(other.matchLabelKeys, matchLabelKeys) &&
    ...
    if (value is Map) {
      ...
      return IoK8sApiCoreV1TopologySpreadConstraint(
        ...
        matchLabelKeys: json[r'matchLabelKeys'] is Iterable
            ? (json[r'matchLabelKeys'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static Map<String, List<IoK8sApiCoreV1TopologySpreadConstraint>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1TopologySpreadConstraint.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
