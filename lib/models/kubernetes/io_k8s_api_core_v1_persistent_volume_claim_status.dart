...
class IoK8sApiCoreV1PersistentVolumeClaimStatus {
  ...
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PersistentVolumeClaimStatus &&
    ...
    _deepEquality.equals(other.allocatedResources, allocatedResources) &&
  ...
  static IoK8sApiCoreV1PersistentVolumeClaimStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1PersistentVolumeClaimStatus(
        ...
        conditions: IoK8sApiCoreV1PersistentVolumeClaimCondition.listFromJson(json[r'conditions']),
  ...
  static Map<String, List<IoK8sApiCoreV1PersistentVolumeClaimStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1PersistentVolumeClaimStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
