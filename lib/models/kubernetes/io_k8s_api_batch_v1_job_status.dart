...
class IoK8sApiBatchV1JobStatus {
  ...
  static IoK8sApiBatchV1JobStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiBatchV1JobStatus(
        ...
        completionTime: mapDateTime(json, r'completionTime', r''),
        conditions: IoK8sApiBatchV1JobCondition.listFromJson(json[r'conditions']),
  ...
  static Map<String, List<IoK8sApiBatchV1JobStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiBatchV1JobStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
