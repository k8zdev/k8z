...
class IoK8sApiCoreV1NamespaceStatus {
  ...
  static IoK8sApiCoreV1NamespaceStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1NamespaceStatus(
        conditions: IoK8sApiCoreV1NamespaceCondition.listFromJson(json[r'conditions']),
  ...
  static Map<String, List<IoK8sApiCoreV1NamespaceStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoK8sApiCoreV1NamespaceStatus.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
